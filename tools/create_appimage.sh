...
linuxdeployqt appdir/usr/share/applications/planova.desktop -bundle-non-qt-libs \
	|| error "linuxdeployqt has failed"

appimagetool appdir --verbose -n -u "zsync|https://releases.planova.org/snapshots/latest-$branch/PLAnova-x86_64.AppImage.zsync" \
