 ...
 * If such a header was included in the library, the class definition would look different for the library than for the planova-server, which could be potentially desasterous. (just think of accessing blubb, or destructors, or copying it by size, or…)
*/
