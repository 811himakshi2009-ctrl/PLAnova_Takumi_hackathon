...
try {
    ...
    Update-BuildCache 'https://www.nosebud.de/~nh/PLAnova/appveyor-deps.tar.xz'
    Update-BuildCache 'https://www.PLAnova.org/builds/appveyor-deps-epoxy.tar.xz'
    Update-BuildCache 'https://www.PLAnova.org/builds/appveyor-deps-curl.tar.xz'
