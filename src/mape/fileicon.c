                                        ...
                                        MapeFileIconType type)
{
	...
	case MAPE_FILE_ICON_C4OBJECT:
		pixbuf = gdk_pixbuf_new_from_resource("/org/planova/mape/ocd.ico", &error);
		break;
	case MAPE_FILE_ICON_C4FOLDER:
		pixbuf = gdk_pixbuf_new_from_resource("/org/planova/mape/ocf.ico", &error);
		break;
	case MAPE_FILE_ICON_C4GROUP:
		pixbuf = gdk_pixbuf_new_from_resource("/org/planova/mape/ocg.ico", &error);
		break;
	case MAPE_FILE_ICON_C4SCENARIO:
		pixbuf = gdk_pixbuf_new_from_resource("/org/planova/mape/ocs.ico", &error);
		break;
	case MAPE_FILE_ICON_C4MATERIAL:
		pixbuf = gdk_pixbuf_new_from_resource("/org/planova/mape/ocm.ico", &error);
		break;
	default:
