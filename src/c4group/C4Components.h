...
#define C4CFN_Log             "PLAnova.log"
#define C4CFN_LogEx           "PLAnova%d.log" // created if regular logfile is in use
#define C4CFN_LogShader       "PLAnovaShaders.log" // created in editor mode to dump shader code
