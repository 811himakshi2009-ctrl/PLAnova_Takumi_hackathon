...
!define MUSICPACK_URL "http://www.planova.org/download/Music.ocg"
...
Function MusicPackDownload
	...
	StrCpy $TempMusicFn "$TEMP\PLAnovaSoundtrack"
	...
	MessageBox MB_OK|MB_ICONEXCLAMATION "Download error $0. You can also get the music pack directly from the PLAnova website." /SD IDOK
	Goto musicdldone
musicdlok:
